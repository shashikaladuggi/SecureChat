...
def generate_keys():
    ...
    """
    public_key, secret_key = pqcrypto.kem.frodo976aes.keypair()
...
def encapsulate(public_key):
    ...
    """
    ciphertext, shared_secret = pqcrypto.kem.frodo976aes.encapsulate(public_key)
...
def decapsulate(secret_key, ciphertext):
    ...
    """
    shared_secret = pqcrypto.kem.frodo976aes.decapsulate(secret_key, ciphertext)
